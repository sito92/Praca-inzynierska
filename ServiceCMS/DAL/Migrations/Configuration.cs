    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DAL.Models.ServiceCMSContext>
    {
        ...
        private void SeedServicePhrases(ServiceCMSContext context)
        {
            context.Phases.AddOrUpdate(x => x.Name,
                ...
                new ServicePhase() { Name = "Modelowanie F", DelayInMinutes = 0, DurationInMinutes = 30, Order = 4, ServiceTypeId = 2 },
                new ServicePhase() { Name = "Farbowanie F", DelayInMinutes = 40, DurationInMinutes = 40, Order = 2, ServiceTypeId = 2 },
